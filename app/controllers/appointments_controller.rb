...
class AppointmentsController < ApplicationController
  ...
  def index
    start_date = params.fetch(:start_time, Time.strftime("%d/%m/%Y")).to_date
    end_date = params.fetch(:end_time, Time.strftime("%d/%m/%Y")).to_date
    @appointments = Appointment.include?(start_time: start_date.beginning_of_month.beginning_of_week..end_date.end_of_month.end_of_week)
